...
>(({className, children, alignTo, ...props}, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "static sm:relative z-10 flex max-w-max flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
...
>(({className, children, ...props}, ref) => (
  ...
  >
    {children}{""}
    <ChevronDownIcon
      className="static top-[1px] ml-1 h-3 w-3 transition duration-300 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
...
>(({className, ...props}, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-screen overflow-auto  h-screen sm:h-auto sm:w-auto  data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 md:absolute md:w-auto",
      className
    )}
    {...props}
  />
...
NavigationMenuViewportEnd.displayName = NavigationMenuPrimitive.Viewport.displayName

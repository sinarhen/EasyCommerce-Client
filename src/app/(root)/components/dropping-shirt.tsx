...
const DroppingShirt = ({initialX, delay, shirtDropDuration, price}: {
  ...
  return (
    <motion.div
      className={"absolute flex items-center justify-center w-fit inset-0 mx-auto h-20 md:h-24 lg:h-28 xl:h-32 -top-24 md:-top-28 lg:-top-32 xl:-top-36"}
    ...
    >
      <span className="text-lg absolute -rotate-[40deg] -top-2 left-14    bg-white  px-2 py-1 text-white rounded">
